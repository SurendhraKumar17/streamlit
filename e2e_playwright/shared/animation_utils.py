...
def wait_for_animation_to_be_hidden(app: Page, animation_images: Locator):
    """
    ...
    Notes
    -----
    This function will wait up to 5 seconds for each animation element
    to move outside the viewport before continuing.
    """
